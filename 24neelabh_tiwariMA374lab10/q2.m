...
ylabel('Price');
title('In real world');
saveas(gcf,'real_world_reduce_var.png');
...
saveas(gcf,'risk_free_world_reduce_var.png');
...
xlabel('Initial Stock price');
ylabel('Put Price');
saveas(gcf, 'vary_init_reduce_var.png')
...
xlabel('Strike Price');
ylabel('Put Price');
saveas(gcf, 'vary_K_reduce_var.png')
...
xlabel('Risk-free rate');
ylabel('Put Price');
saveas(gcf, 'vary_r_reduce_var.png')
...
xlabel('Volatility');
ylabel('Put Price');
saveas(gcf, 'vary_sigma_reduce_var.png')
...
ylabel('Put Price');
ylim([3,5])
saveas(gcf, 'vary_T_reduce_var.png')
